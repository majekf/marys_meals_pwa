...
Na obrazovkách hier (Miska jedla, Kuchyňa dobrovoľníkov) sa navyše zobrazujú **šípky ‹ / ›** pre priamy prechod na predchádzajúcu alebo nasledujúcu hru – bez potreby vracať sa do menu hier. Zobrazí sa len šípka, ktorá má zmysel (napr. pri prvej hre len šípka doprava).
